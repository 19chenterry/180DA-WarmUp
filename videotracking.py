...
Masking/filtering - https://docs.opencv.org/4.x/df/d9d/tutorial_py_colorspaces.html
    Changed thresholding range to better identify selected object (notebook)
Bounding Box - https://stackoverflow.com/questions/23398926/drawing-bounding-box-around-given-size-area-contour
    Change to only display largest object
Dominant Color - https://code.likeagirl.io/finding-dominant-colour-on-an-image-b4e075f98097
    Change to display live histogram
"""
...
while(1):
    ...
    if type(cont) != int and type(cont) != float:
        ...
        cv.putText(frame,'Notebook',(x+w+10,y+h),0,0.3,(0,255,0))
